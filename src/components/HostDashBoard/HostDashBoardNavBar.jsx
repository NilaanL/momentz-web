...
import { signOutWithGoogle } from "../googleAuth/GoogleAuth";
...
function HostDashboardNavBar({ user, setCurrentSection }) {
  ...
  const handleCloseNavMenu = (page) => {
    ...
    if (page === "Guest List") {
      setCurrentSection("guestList");
    } else if (page === "All Photos") {
      setCurrentSection("allPhotos");
    } else if (page === "Event Details") {
      setCurrentSection("eventDetails");
    } else if (page === "Reports") {
      setCurrentSection("reports");
    } else if (page === "Face Groups") {
      setCurrentSection("faceGroups");
    }
  };
